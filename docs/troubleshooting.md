...
| Host rejects the plugin as incompatible | Install `@everclear077/dsh-progressive-tools@0.6.0` with host `0.1.7-rc.2`. Version `0.5.1` only accepts host `0.1.5-rc.1`. |
